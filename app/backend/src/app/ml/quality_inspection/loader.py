...
from app.data.loaders import SteelPlatesDatasetLoader

logger = logging.getLogger(__name__)


class QualityInspectionLoader:
    """Loads Steel Plates Faults dataset with validation and profiling."""

    def __init__(self, source_path: Path | str) -> None:
        self.source_path = Path(source_path)
        self.loader = SteelPlatesDatasetLoader(source_path)
        logger.info(f"Initialized QI loader for {source_path}")
